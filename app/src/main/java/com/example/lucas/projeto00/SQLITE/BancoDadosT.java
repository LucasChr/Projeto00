...
public class BancoDadosT {
    ...
    private static final String NOME_BANCO = "ProjetoT";
    private static final int VERSAO_BANCO = 2;

    private static final String[] SCRIPT_DATABASE_DELETE = new String[]{"drop table if exists tbl_turisticos;"};
    private static final String[] SCRIPT_DATABASE_CREATE = new String[]{"create table tbl_turisticos(_id integer primary key, nome text, latitude text, longitude text);"};
